          ...
          >
            ...
            <header className="resume-header">
              ...
              <div className="resume-social-links">
                <a href="https://www.instagram.com/a_llen___?igsh=MTdiM2FlNmtsd2Yx" target="_blank" rel="noreferrer" onMouseEnter={() => handleCursorHover('IG')} onMouseLeave={handleCursorLeave}>INSTAGRAM</a>
                <a href="https://www.fiverr.com/s/42VKoVR" target="_blank" rel="noreferrer" onMouseEnter={() => handleCursorHover('FVR')} onMouseLeave={handleCursorLeave}>FIVERR</a>
                <a href="https://www.linkedin.com/in/allen-biju-2b7458291?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noreferrer" onMouseEnter={() => handleCursorHover('LNKD')} onMouseLeave={handleCursorLeave}>LINKEDIN</a>
              </div>
            </header>
